...
const THEMES: Theme[] = [
  {
    id: 'black',
    name: 'Black Metal',
    bgGradient: 'bg-[linear-gradient(145deg,#1A1A1A,#303030)]',
    textColor: 'text-white',
    borderColor: 'border-[#3A3A3A]',
    inputBg: 'bg-[#252525]/40',
  ...
  },
  {
    id: 'gold',
    name: 'Gold Metal',
    bgGradient: 'bg-[linear-gradient(145deg,#D4C088,#BBA05F)]',
    textColor: 'text-[#3a2d1b]',
    borderColor: 'border-[#C5B686]',
    inputBg: 'bg-[#CAB980]/15',
    inputText: 'text-[#3a2d1b]',
    placeholderText: 'text-[#3a2d1b]/40',
  ...
  },
  {
    id: 'lavender',
    name: 'Lavender Metal',
    bgGradient: 'bg-[linear-gradient(145deg,#C7B8E0,#9785C0)]',
    textColor: 'text-white',
    borderColor: 'border-[#A48FCB]',
    inputBg: 'bg-[#A490C4]/20',
    inputText: 'text-white',
    placeholderText: 'text-white/40',
  ...
  },
  {
    id: 'space-grey',
    name: 'Space Grey',
    bgGradient: 'bg-[linear-gradient(145deg,#8A8A8F,#5E5D60)]',
    textColor: 'text-white',
    borderColor: 'border-[#7B7A7E]',
    inputBg: 'bg-[#7C7B7F]/20',
    inputText: 'text-white',
    placeholderText: 'text-white/40',
  ...
  },
  {
    id: 'rose-gold',
    name: 'Rose Gold',
    bgGradient: 'bg-[linear-gradient(145deg,#E5C0BB,#C4938B)]',
    textColor: 'text-[#2d1b1b]',
    borderColor: 'border-[#D1A39D]',
    inputBg: 'bg-[#D5A59E]/15',
    inputText: 'text-[#2d1b1b]',
    placeholderText: 'text-[#2d1b1b]/40',
            ...
            <div className="relative mb-4 sm:mb-6 pb-8">
              ...
              <div className="rounded-2xl overflow-hidden max-w-sm mx-auto relative">
                ...
                <div className={`relative aspect-[3/2] w-full ${currentTheme.bgGradient}`}>
                  {/* More subtle metallic effects */}
                  <div className="absolute inset-0 bg-gradient-to-b from-white/15 to-transparent opacity-60" />
                  <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.15),transparent_40%,rgba(0,0,0,0.05))]" />
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_-20%,rgba(255,255,255,0.25),transparent_70%)]" />
                  ...
                  <div className="relative flex flex-col items-center justify-center h-full">
                    ...
                    <div className="flex flex-col items-center px-6 sm:px-8 py-5 sm:py-6 w-full">
                      ...
                      >
                        <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-2 border-white/20 shadow-[0_2px_10px_rgba(0,0,0,0.08)]">
                          <div className="absolute inset-0 rounded-full bg-black/5 backdrop-blur-sm"></div>
                          ...
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/25 rounded-full backdrop-blur-sm">
                      ...
                      <div className="relative group w-full max-w-[280px] mx-auto mt-5 sm:mt-6">
                        <div className="relative">
                          <div className="absolute inset-0 bg-black/5 rounded-2xl backdrop-blur-md shadow-[0_6px_18px_rgba(0,0,0,0.08)]" />
                          <div className={`relative ${currentTheme.inputBg} rounded-2xl p-3 border ${currentTheme.borderColor}/20 shadow-[0_4px_14px_rgba(0,0,0,0.10)]`}>
                            <div
                            ...
                            <div className="flex flex-wrap justify-center gap-2">
                              {profileData.tags.map((tag, index) => (
                                <motion.div
                                  ...
                                  initial={{ scale: 0 }}
                                  animate={{ scale: 1 }}
                                  className={`group relative px-3 py-2 rounded-xl bg-white/10 backdrop-blur-sm ${currentTheme.textColor} text-sm font-medium flex items-center gap-1.5 hover:bg-white/15 transition-all duration-300 shadow-[0_2px_8px_rgba(0,0,0,0.10)] font-space-grotesk min-h-[44px] border border-white/5`}
                                >
                              ...
                              {profileData.tags.length < 3 && (
                                <input
                                  ...
                                  className={`px-3 py-2 rounded-xl bg-white/5 ${currentTheme.inputText} text-sm font-medium border-2 border-dashed ${currentTheme.borderColor}/15 hover:${currentTheme.borderColor}/25 focus:outline-none focus:${currentTheme.borderColor}/30 w-32 shadow-[0_2px_8px_rgba(0,0,0,0.10)] font-space-grotesk min-h-[44px] text-center placeholder:${currentTheme.placeholderText} transition-colors duration-300`}
                      ...
                      <div className="mt-6 sm:mt-8">
                        <div className="relative">
                          <div className="absolute inset-0 bg-black/5 rounded-2xl backdrop-blur-md shadow-[0_6px_18px_rgba(0,0,0,0.08)]" />
                          <div className="relative bg-black/5 rounded-2xl p-4 border border-white/5 shadow-[0_4px_14px_rgba(0,0,0,0.10)]">
                            <div className="grid grid-cols-5 gap-3 justify-items-center">
                              {THEMES.map((theme) => (
                                <button
                                  ...
                                  className={`relative group w-14 h-14 rounded-full overflow-hidden transition-all duration-300 transform hover:scale-110 ${
                                    profileData.theme === theme.id 
                                      ? 'ring-1 ring-white/60 shadow-[0_0_15px_rgba(255,255,255,0.25)]' 
                                ...
                                >
                                  ...
                                  {/* Metallic effects - more subtle */}
                                  <div className="absolute inset-0 bg-gradient-to-b from-white/25 to-transparent opacity-60" />
                                  <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.2),transparent_40%,rgba(0,0,0,0.05))]" />
                                  ...
                                  <div className="absolute inset-0 flex items-center justify-center bg-black/0 group-hover:bg-black/5 transition-colors duration-300">
                                    <span className={`${theme.textColor} text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300 drop-shadow-md text-center px-1`}>
                                      {theme.name.split(' ')[0]}
                                    </span>
                                  </div>
                                </button>
