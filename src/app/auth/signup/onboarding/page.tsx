...
export default function ProfileBuilderPage() {
  ...
  return (
    <>
      <NavigationBar showBack xp={0} userAvatar={profile.profilePicture} />
      
      <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-8 bg-white pt-24">
